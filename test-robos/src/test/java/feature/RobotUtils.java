...
/**
 * RobotUtils is a helper that simplifies and facilitates the work with keyboard and mouse.
 */
public final class RobotUtils {
     ...
     *
     * @param awtRobot
     *            instance of java.awt.Robot that will be used for sending keys, moving mouse, ...
     * @exception NullPointerException
     *                if {@code awtRobot} is {@code null}
     */
     ...
     * 
     * @param delay
     *            time to sleep in milliseconds after generating an event.
     * @throws IllegalArgumentException
     *             if {@code delay} is not between 0 and 60,000 milliseconds inclusive
     */
     ...
     * 
     * @param isOn
     *            Whether {@code waitForIdle} is automatically invoked
     */
     ...
     * @throws IllegalArgumentException
     *             if {@code ms} is not between 0 and 60,000 milliseconds inclusive
     ...
     * 
     * @param keyCode
     *            Key to press (e.g. {@code KeyEvent.VK_A})
     * @throws IllegalArgumentException
     *             if {@code keyCode} is not a valid key
     ...
     * 
     * @param text
     *            a string, each character of {@code text} will be sent (e.g. {@code "Hello, my RobotUtils!"})
     */
     ...
     *            Key to press (e.g. {@code KeyEvent.VK_A})
     * @param numberTimes
     *            a specified number of times, a given key will sent.
     * @throws IllegalArgumentException
     *             if {@code keyCode} is not a valid key
     * @see java.awt.event.KeyEvent
     */
     ...
     *            a string, each character of {@code text} will be sent (e.g. {@code "Hello, my RobotUtils!"})
     * @param numberTimes
     *            a specified number of times, a given {@code text} will sent.
     */
     ...
     * 
     * @param shortcut
     *            int[] from {@code com.testassistant.Shortcuts} that represent a shortcut.
     * @see com.testassistant.Shortcuts
     */
     ...
     * 
     * @param keyCode
     *            key code of KeyEvent, the valid values - {@code KeyEvent.VK_SCROLL_LOCK}, {@code KeyEvent.VK_NUM_LOCK}
     ...
     *                if {@code keyCode} is not one of the valid key codes
     * @exception java.lang.UnsupportedOperationException
     *                if the host system doesn't allow getting the state of this key programmatically, or if the
     ...
     *
     * @param text
     *            a string that will be copied to the System Clipboard and after that will be pasted from it.
     *            <p>
     * @exception HeadlessException
     ...
     *            the Button mask; a combination of one or more mouse button masks.
     *            <p>
     ...
     *                if the {@code mouseButtonCode} mask contains the mask for extra mouse button and support for
     *                extended mouse buttons is {@link Toolkit#areExtraMouseButtonsEnabled() disabled} by Java
     * @exception IllegalArgumentException
     *                if the {@code mouseButtonCode} mask contains the mask for extra mouse button that does not exist
     ...
     *            {@code InputEvent.BUTTON3_DOWN_MASK}
     * @param numberTimes
     *            a specified number of times, the Button mask will sent.
     *
     * @exception IllegalArgumentException
     *                if the {@code mouseButtonCode} mask contains the mask for extra mouse button and support for
     *                extended mouse buttons is {@link Toolkit#areExtraMouseButtonsEnabled() disabled} by Java
     ...
     * 
     * @param mouseKeyCode
     *            mouse mask, {@code InputEvent.BUTTON1_DOWN_MASK}, {@code InputEvent.BUTTON2_DOWN_MASK},
     *            {@code InputEvent.BUTTON3_DOWN_MASK}
     */
